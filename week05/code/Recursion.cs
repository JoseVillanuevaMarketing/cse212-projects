    ...
    public static void WildcardBinary(string pattern, List<string> results)
{
        ...
        List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        SolveMaze(results, maze, x + 1, y,
            new List<ValueTuple<int, int>>(currPath)); // Right

        SolveMaze(results, maze, x - 1, y,
            new List<ValueTuple<int, int>>(currPath)); // Left

        SolveMaze(results, maze, x, y + 1,
            new List<ValueTuple<int, int>>(currPath)); // Down

        SolveMaze(results, maze, x, y - 1,
            new List<ValueTuple<int, int>>(currPath)); // Up
    }
}